<?php 
class CMQSActiveDataProvider extends CDataProvider
{
/**
	...
	public $unsetarr=array();
	
	
	public $functionname='staticInformation';
	...
	{
		require_once(Yii::app()->basePath.'/extensions/newterminalfunction.php');
		...
		foreach($data as $k=>$v)
		{
			//$dd=getAllRate($v['attributes']['id'])
		
			//$daaa=$data[$k]['attributes'];
			//$daaa['baseband']=$td;
			//$daaa['active_count']=$mtd;
			//$daaa['province_city_id']=getRssiSituation($td,$gsm);
			//$daaa['operator_list_id']=$gsm;
			//$daaa['modified_at']=$mgsm;
		}
